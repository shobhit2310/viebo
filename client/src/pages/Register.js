    ...
    <ParticleBackground>
        ...
        <div className="auth-card">
          <div className="auth-content">
            <div className="auth-header">
              ...
              <p className="auth-subtitle">Create your account in one tap.</p>
            </div>
            ...
            <p className="auth-info-text">
              We will use your Google account to create your Viebo profile securely.
            </p>
      ...
      <style jsx>{`
        ...
        .auth-info-text {
          ...
          margin: 20px 0;
          line-height: 1.5;
          animation: slideUpFade 0.6s cubic-bezier(0.23, 1, 0.32, 1) 0.45s both;
        }
